...
var elasticsearchUrl = process.env.ELASTICSEARCH_URL || 'http://localhost:9200';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, exports.esClient.cluster.health()];
                case 1:
                    health = _a.sent();
                    return [2 /*return*/, health.status !== 'red'];
                case 2:
                    error_1 = _a.sent();
                    console.error('Elasticsearch health check failed:', error_1);
...
function initializeElasticsearch() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, checkElasticsearchHealth()];
                case 1:
                    isHealthy = _a.sent();
                    if (!isHealthy) {
